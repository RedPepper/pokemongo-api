...
DailyQuestSettings = _reflection.GeneratedProtocolMessageType('DailyQuestSettings', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Settings.Master.Quest_pb2'
