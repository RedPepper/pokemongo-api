...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  public_dependencies=[POGOProtos_dot_Networking_dot_Requests__pb2.DESCRIPTOR,POGOProtos_dot_Networking_dot_Platform__pb2.DESCRIPTOR,])
